      ...
      <div className=" container m-auto  mt-16">
        ...
        <div className="flex md:flex-col ">
          <div className="left flex-1 w-full">
            ...
            <div
              data-aos="zoom-in"
              className="text- black progress flex items-center h-[100%] justify-end md:justify-center"
            >
              <div className=" flex flex-col gap-6 text-black w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<SiMicrosoftexcel />} name={"Excel"} value={96} />
                <ProgressBar
                  logo={<DiPostgresql />}
                  name={"PostgreSQL"}
                  value={95}
          ...
          <div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
            ...
            <div className="last2 flex flex-col gap-10">
              ...
              { <SkillBox
                className=""
                logo={
                  <DiPostgresql className=" text-white bg-black rounded-full h-fit border-white overflow-hidden" />
                }
                black={"black"}
                white={"white"}
                skill={"Postgre SQL"}
