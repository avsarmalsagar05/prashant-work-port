  ...
  return (
    <div
      className={`w-full mx-auto  fixed top-0 py-5 sm:py-4 z-30 ${
        scrollPosition > 0 ? `bg-gray-100 shadow-md` : "bg-transparent"
      } `}
    >
      <nav className=" container m-auto flex items-center justify-between">
        <div data-aos="fade-down" className="logo">
          <Link
            ...
            to="/"
            className="text-3xl font-bold sm:text-3xl hover:text-red-500 font-bold"
          >
            Prashant Av.
          </Link>
        </div>
        ...
        >
          ...
          >
            ...
            {navItems.map((item) => (
              ...
              >
                <a
                  ...
                  href={`#${item.name}`}
                  className={`uppercase cursor-pointer text-black-900 hover:text-red-400 font-bold ${
            ...
            <a
              href="#letschat"
              className="bg-white text-[1rem] text-black px-8 py-2 rounded-lg font-bold hover:text-red-400 bg-white md:m-5 md:block md:mx-auto md:w-fit lg:px-3"
            >
              Let's Chat
            </a>
          </ul>
